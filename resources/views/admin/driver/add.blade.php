...
@section('content')
<form action="{{route('driver.store')}}"  method="POST" enctype="multipart/form-data" id="driver_create">
    @csrf
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-md-4">
                                           <div class="form-group">
                                              ...
                                              <input class="form-control" name="Date_Of_Birth" type="date" id="Date_Of_Birth" required>
                                           </div>
                                        </div>
                                        <div class="col-md-2">
                                           <div class="form-group">
                                              <label><b>Height (cm)</b></label>
                                              <input class="form-control" name="Height_Cm" type="text" required>
                                           </div>
                                        </div>
                                        <div class="col-md-2">
                                           <div class="form-group">
                                              <label><b>Weight (lbs)</b></label>
                                              <input class="form-control" name="Weight_Ibs" type="text" required>
                                           </div>
                                        </div>
                                     </div>
                                  </div>
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-md-4">
                                           <div class="form-group">
                                              ...
                                              <input type="text" name="Apt_Suite_Other" class="form-control" required>
                                           </div>
                                        </div>
                                        <div class="col-md-4">
                                           <div class="form-group">
                                              <label><b>Driver Image</b></label>
                                              <input name="Driver_Image" type="file" required>
                                           </div>
                                        </div>
                                     </div>
                                     <div class="row">
                                        ...
                                        <div class="col-md-2">
                                           <div class="form-group">
                                              ...
                                              <input class="form-control" name="Zip_Code" type="text" id="Zip_Code" required>
                                           </div>
                                        </div>
                                        <div class="col-md-4">
                                           <div class="form-group">
                                              <label><b>Documents</b></label>
                                              <input name="Documents" type="file" required>
                                           </div>
                                        </div>
                                     </div>
                                     <div class="row">
                                        <div class="col-md-4">
                                           <div class="form-group">
                                              ...
                                              <input class="form-control" maxlength="15" name="Phone_Number" type="text" id="Phone_Number" onkeypress="checkValidatPhoneNumber()" required>
                                           </div>
                                        </div>
                                        <div class="col-md-4">
                                           <div class="form-group">
                                              <label><b>Secondary Phone No</b></label>
                                              <input type="text" name="Secondary_Phone_No" maxlength="15" id="Secondary_Phone_No" onkeypress="checkValidatSecondaryPhoneNo()" class="form-control" required>
                                           </div>
                                        </div>
                                        <script>
                                        ...
                                        <div class="col-md-4">
                                           <div class="form-group">
                                              ...
                                              <input name="License_Image" type="file" required>
                                           </div>
                                        </div>
                                     </div>
                                     <div class="row">
                                        <div class="col-md-4">
                                           <div class="form-group">
                                              <label><b>Email Address</b></label>
                                                 <input class="form-control" name="Email_Address" type="email" id="Email_Address" required>
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-md-4">
                                           <div class="form-group">
                                              ...
                                              <input type="text" name="Dln_State" class="form-control" required>
                                           </div>
                                        </div>
                                        <div class="col-md-2">
                                           <div class="form-group">
                                              ...
                                              <div class="input-group date">
                                                 ...
                                                 <input class="form-control" name="Issue_Date" type="date" id="Issue_Date" required>
                                              </div>
                                           </div>
                                        </div>
                                        <div class="col-md-2">
                                           <div class="form-group">
                                              ...
                                              <div class="input-group date">
                                                 ...
                                                 <input class="form-control" name="Expiration_Date" type="date" id="Expiration_Date" required>
                                              </div>
                                           </div>
                                        </div>
                                     </div>
                                     ...
                                     <div class="row">
                                        <div class="col-md-4">
                                           <div class="form-group">
                                              ...
                                              <input type="text" name="Chauffeur_Number" id="chaferNum" class="form-control" required>
                                           </div>
                                        </div>
                                        <div class="col-md-2">
                                           <div class="form-group">
                                              <label><b>Status</b></label>
                                              <input class="form-control" readonly="" name="status_c" id="status_c" type="text" required>
                                           </div>
                                        </div>
                                        <div class="col-md-2">
                                           <div class="form-group">
                                              <label><b>Status Date</b></label>
                                              <input class="form-control" id="status_date" readonly="" name="status_date" type="text" required>
                                           </div>
                                        </div>
                                        <div class="col-md-2">
                                           <div class="form-group">
                                              <label><b>Driver type</b></label>
                                              <input class="form-control" id="d_type" readonly="" name="d_type" type="text" required>
                                           </div>
                                        </div>
                                        <div class="col-md-2">
                                           <div class="form-group">
                                              <label><b>License type</b></label>
                                              <input class="form-control" id="l_type" readonly="" name="l_type" type="text" required>
                                           </div>
                                        </div>
                                     </div>
                                     <div class="row">
                                        <div class="col-md-4">
                                           <div class="form-group">
                                              ...
                                              <input class="form-control" id="ch_name" readonly="" name="ch_name" type="text" required>
                                           </div>
                                        </div>
                                        <div class="col-md-2">
                                           <div class="form-group">
                                              <label for="c_gender" class="form-label required"><b>Gender</b></label>
                                              <input class="form-control" id="ch_gender" readonly="" name="ch_gender" type="text" required>
                                           </div>
                                        </div>
                                        <div class="col-md-2">
                                           <div class="form-group">
                                              <label for="c_city" class="form-label required"><b>Chauffeur City</b></label>
                                              <input class="form-control" id="ch_city" readonly="" name="ch_city" type="text" required>
                                           </div>
                                        </div>
                                        <div class="col-md-2">
                                           <div class="form-group">
                                              <label for="c_state" class="form-label required"><b>Chauffeur State</b></label>
                                              <input class="form-control" id="ch_state" readonly="" name="ch_state" type="text" required>
                                           </div>
                                        </div>
                                     </div>
                                  </div>
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-md-3">
                                           <div class="form-group">
                                              ...
                                              <input type="text" name="Social_Security_Number" minlength="11" onkeypress="checkValidatSocial()" id="Social_Security_Number" maxlength="11" class="form-control" required>
                                           </div>
                                        </div>
                                        <script>
                                        ...
                                        <div class="col-md-3">
                                           <div class="form-group">
                                              ...
                                              <input type="text" name="Run_ID" class="form-control" required>
                                           </div>
                                        </div>
                                     </div>
                                     <div class="row">
                                        <div class="col-md-3">
                                           <div class="form-group">
                                              <label><b>Driver Type</b></label>
                                              <select id="s_driver_type" name="Driver_Type" class="form-control" required>
                                        ...
                                        <div class="col-md-3">
                                           <div class="form-group">
                                              ...
                                              <select id="assign_vehicle" name="Assign_Vehicle" class="form-control" required>
                                        ...
                                        <div class="col-md-3">
                                           <div class="form-group">
                                              ...
                                              <select id="s_driver_performance" name="Performance_type" class="form-control" required>
                                     ...
                                     <div class="rows">
                                        <div class="col-md-12">
                                           <div class="form-group">
                                              ...
                                              <textarea class="form-control" name="Remarks" cols="50" rows="10" id="econtact" required></textarea>
                                           </div>
                                        </div>
                                     </div>
                                     <div class="row">
                                        <div class="col-md-3">
                                           <div class="form-group">
                                              ...
                                              <input type="checkbox" id="flexCheck" name="flexable_hrs" onclick="flexFunction()" required>
                                           </div>
                                           <div class="row" id="flexhr" style="display:none">
                                              <div class="col-md-12">
                                                 <div class="form-group">
                                                    <label for="Flexible_Side" class="form-label">Flexible Side</label>
                                                    <select id="Flexible_Side" name="Flexible_Side" class="form-control" required>
                                              ...
                                              <div class="col-md-12">
                                                 <div class="form-group">
                                                    ...
                                                    <select id="Flexible_Hours" name="Flexible_Hours" class="form-control" required>
                                        ...
                                        <div class="col-md-3">
                                           <div class="form-group">
                                              ...
                                              <input type="checkbox" id="Special_Hrs_1" name="Special_Hrs_1" onclick="myFunction()" required>
                                           </div>
                                           <div class="row" id="s_hr" style="display:none">
                                              <div class="col-md-12">
                                                 <div class="form-group">
                                                    <label for="Speacial_Day" class="form-label">Speacial Day</label>
                                                    <select id="Speacial_Day" name="Speacial_Day" class="form-control" required>
                                              ...
                                              <div class="col-md-12">
                                                 <div class="form-group">
                                                    ...
                                                    <input class="form-control" autofocus="" name="Special_Time_Start" type="time" id="Special_Time_Start" required>
                                                 </div>
                                              </div>
                                              <div class="col-md-12">
                                                 <div class="form-group">
                                                    <label for="s_time_end" class="form-label">Special Time End</label>
                                                    <input class="form-control" autofocus="" name="Special_Time_End" type="time" id="Special_Time_End" required>
                                                 </div>
                                              </div>
                                           </div>
                                        </div>
                                        <div class="col-md-2">
                                           <div class="form-group">
                                              ...
                                              <input type="checkbox" id="Available_All_Time" name="Available_All_Time" required>
                                           </div>
                                        </div>
                                        <div class="col-md-2">
                                           <div class="form-group">
                                              <label for="inActive" class="form-label">inActive</label>
                                              <input type="checkbox" checked="" id="inActive" name="inActive" required>
                                           </div>
                                        </div>
                                        <div class="col-md-2">
                                           <div class="form-group">
                                              <label for="peace_hrs" class="form-label">Pace Program</label>
                                              <input type="checkbox" name="Pace_Program" id="Pace_Program" required>
                                           </div>
                                        </div>
                                        <div class="col-md-12">
