                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-success mb-3">
                                            <div class="bg-primary card-header">
                                                <h3 class="card-title">Edit Master Schedule</h3>
                                            </div>
                                            <!-- /.card-header -->
                                            <div class="card-body">
                                                <!-- <div class="container" > -->
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-3 checkbox">
                                                                    <input type="text" id="timepicker3" data-day-starttimearray="Sunday" class="timepicker11 tp" name="startTimeArray[]" disabled="" placeholder="0:00 AM/PM" readonly="" />
                                                                    <input type="text" id="timepicker5" data-day-starttimearray="Monday" class="timepicker11 tp" name="startTimeArray[]" disabled="" placeholder="0:00 AM/PM" readonly="" />
                                                                    <input type="text" id="timepicker7"  data-day-starttimearray="Tuesday" class="timepicker11 tp" name="startTimeArray[]" disabled="" placeholder="0:00 AM/PM" readonly="" />
                                                                    <input type="text" id="timepicker9"  data-day-starttimearray="Wednesday" class="timepicker11 tp" name="startTimeArray[]" disabled="" placeholder="0:00 AM/PM" readonly="" />
                                                                    <input type="text" id="timepicker11"  data-day-starttimearray="Thursday" class="timepicker11 tp" name="startTimeArray[]" disabled="" placeholder="0:00 AM/PM" readonly="" />
                                                                    <input type="text" id="timepicker13"  data-day-starttimearray="Friday" class="timepicker11 tp" name="startTimeArray[]" disabled="" placeholder="0:00 AM/PM" readonly="" />
                                                                    <input type="text" id="timepicker15"  data-day-starttimearray="Saturday" class="timepicker11 tp" name="startTimeArray[]" disabled="" placeholder="0:00 AM/PM" readonly="" />
                                                                </div>

                                                                <div class="col-sm-3 checkbox">
                                                                    <input type="text" id="timepicker4"  data-day-offtimearray="Sunday" class="timepicker22 tp" name="offTimeArray[]" disabled="" placeholder="0:00 AM/PM" readonly="" />
                                                                    <input type="text" id="timepicker6"  data-day-offtimearray="Monday" class="timepicker22 tp" name="offTimeArray[]" disabled="" placeholder="0:00 AM/PM" readonly="" />
                                                                    <input type="text" id="timepicker8"  data-day-offtimearray="Tuesday" class="timepicker22 tp" name="offTimeArray[]" disabled="" placeholder="0:00 AM/PM" readonly="" />
                                                                    <input type="text" id="timepicker10"  data-day-offtimearray="Wednesday" class="timepicker22 tp" name="offTimeArray[]" disabled="" placeholder="0:00 AM/PM" readonly="" />
                                                                    <input type="text" id="timepicker12"  data-day-offtimearray="Thursday" class="timepicker22 tp" name="offTimeArray[]" disabled="" placeholder="0:00 AM/PM" readonly="" />
                                                                    <input type="text" id="timepicker14"  data-day-offtimearray="Friday" class="timepicker22 tp" name="offTimeArray[]" disabled="" placeholder="0:00 AM/PM" readonly="" />
                                                                    <input type="text" id="timepicker16"  data-day-offtimearray="Saturday" class="timepicker22 tp" name="offTimeArray[]" disabled="" placeholder="0:00 AM/PM" readonly="" />
                                                                </div>

                                                                <div class="col-sm-3 checkbox disabled">
                                                                    <input type="text" id="hr1" data-day-hour="Sunday" class="h tp" disabled="" placeholder="Hour" />
                                                                    <input type="text" id="hr2" data-day-hour="Monday" class="h tp" disabled="" placeholder="Hour" />
                                                                    <input type="text" id="hr3" data-day-hour="Tuesday" class="h tp" disabled="" placeholder="Hour" />
                                                                    <input type="text" id="hr4" data-day-hour="Wednesday" class="h tp" disabled="" placeholder="Hour" />
                                                                    <input type="text" id="hr5" data-day-hour="Thursday" class="h tp" disabled="" placeholder="Hour" />
                                                                    <input type="text" id="hr6" data-day-hour="Friday" class="h tp" disabled="" placeholder="Hour" />
                                                                    <input type="text" id="hr7" data-day-hour="Saturday" class="h tp" disabled="" placeholder="Hour" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        var days = 7;
        var hours;
        var totalHr = {{isset($schedule->total_hours)?$schedule->total_hours:0}};
        var startHour;
        var EndHour;
        var CurrentHour;
        var SpHr = 0;
     ...
     @endif
        ...
        @endif
            ...
            setTimeout(function(){
                @if(isset($schedule->rest_days) && $schedule->rest_days)
                    @foreach($schedule->rest_days as $rest_day)
                        $('[data-day-hour="{{$rest_day}}"]').val('Hour');
                        $('[data-day-starttimearray="{{$rest_day}}"]').val('0:00 AM/PM')
                        $('[data-day-offtimearray="{{$rest_day}}"]').val('0:00 AM/PM')
                        $('[data-day-starttimearray="{{$rest_day}}"]').attr('disabled','disabled')
                        $('[data-day-offtimearray="{{$rest_day}}"]').attr('disabled','disabled')
                    @endforeach
                @endif
            },1)
