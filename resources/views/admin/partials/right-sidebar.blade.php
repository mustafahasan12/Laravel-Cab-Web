        ...
        <div class="sidebar-right-scroll">
            ...
            <div class="sidebar-section">
                ...
                <ul class="theme-colors clearfix">
                    ...
                    <li>
                        <a href="javascript:void(0)" class="themed-background-river themed-border-river" data-theme="{{url('/assets/css/themes/river.css')}}" data-toggle="tooltip" title="River"></a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" class="themed-background-amethyst themed-border-amethyst" data-theme="{{url('/assets/css/themes/amethyst.css')}}" data-toggle="tooltip" title="Amethyst"></a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" class="themed-background-dragon themed-border-dragon" data-theme="{{url('/assets/css/themes/dragon.css')}}" data-toggle="tooltip" title="Dragon"></a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" class="themed-background-emerald themed-border-emerald" data-theme="{{url('/assets/css/themes/emerald.css')}}" data-toggle="tooltip" title="Emerald"></a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" class="themed-background-grass themed-border-grass" data-theme="{{url('/assets/css/themes/grass.css')}}" data-toggle="tooltip" title="Grass"></a>
                    </li>
                </ul>{{url('/assets/css/bootstrap.css')}}
            </div>
            <!-- END Color Themes -->
